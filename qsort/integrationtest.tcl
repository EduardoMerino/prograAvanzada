...
send "name\r"
expect "Student Jhonny 17" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
expect "Student Peter 14" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
expect "Student Maria 20" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
